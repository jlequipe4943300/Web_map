...
map.getView().fit([-8115053.425368, -2825034.053658, -4761602.410673, -979071.853486], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ESTACIONES METEREOLOGIAS DE BOLIVIA</h2>';
        return titleElement;
    })(),
